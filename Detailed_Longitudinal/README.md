...
Dummy data was used to tests the output quality, this data was generated using the `LOIRE` package (https://github.com/holopid/LOIRE) from Ida Holopainen (THL) and modified to fit our format requirements.
