...
def preprocess_avohilmo_icd10_year_11_16():
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_11_16, source='icd10', year='11_16', test=True)
    del icd10_11_16
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_icd10_year_17_19():
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_17_19, source='icd10', year='17_19', test=True)
    del icd10_17_19
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_icd10_year_20_21():
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_20_21, source='icd10', year='20_21', test=True)
    del icd10_20_21
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_icpc2_year_11_16():
    ...
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_11_16, source='icpc2', year='11_16', test=True)
    del icpc2_11_16
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_icpc2_year_17_19():
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_17_19, source='icpc2', year='17_19', test=True)	
    del icpc2_17_19
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_icpc2_year_20_21():
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_20_21, source='icpc2', year='20_21', test=True)	
    del icpc2_20_21
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oral_year_11_16():
    ...
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]    
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_11_16, source='oral', year='11_16', test=True)
    del oral_11_16
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oral_year_17_19():
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_17_19, source='oral', year='17_19', test=True)
    del oral_17_19
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oral_year_20_21():
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_20_21, source='oral', year='20_21', test=True)
    del oral_20_21
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oper_year_11_16():
    ...
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_11_16, source='oper', year='11_16', test=True)	
    del oper_11_16
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oper_year_17_19():
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_17_19, source='oper', year='17_19', test=True)	
    del oper_17_19
    gc.collect() 
    END = datetime.now()
...
def preprocess_avohilmo_oper_year_20_21():
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_20_21, source='oper', year='20_21', test=True)
    del oper_20_21
    gc.collect() 	
    END = datetime.now()
