...
def preprocess_avohilmo_icd10():
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_11_16, source='icd10', test=True)
    del icd10_11_16
    gc.collect() 
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_17_19, source='icd10', test=True)
    del icd10_17_19
    gc.collect() 
    ...
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icd10_20_21, source='icd10', test=True)
    del icd10_20_21
    gc.collect() 
...
def preprocess_avohilmo_icpc2():
    START = datetime.now()		

    icpc2_11_16 = AvoHilmo_codes_preparation(avohilmo_icpc2_2011_2016, source='icpc2', test=True)
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_11_16, source='icpc2', test=True)
    del icpc2_11_16
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_17_19, source='icpc2', test=True)	
    del icpc2_17_19
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=icpc2_20_21, source='icpc2', test=True)	
    del icpc2_20_21
    gc.collect() 
...
def preprocess_avohilmo_oral():
    START = datetime.now()	

    oral_11_16 = AvoHilmo_codes_preparation(avohilmo_oral_2011_2016, source='oral', test=True)
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]    
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_11_16, source='oral', test=True)
    del oral_11_16
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_17_19, source='oral', test=True)
    del oral_17_19
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oral_20_21, source='oral', test=True)
    del oral_20_21
    gc.collect() 
...
def preprocess_avohilmo_oper():
    START = datetime.now()	

    oper_11_16 = AvoHilmo_codes_preparation(avohilmo_oper_2011_2016, source='oper', test=True)
    avohilmo_to_process = [avohilmo_2011_2012,avohilmo_2013_2014,avohilmo_2015_2016]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_11_16, source='oper', test=True)	
    del oper_11_16
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2017_2018,avohilmo_2019_2020]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_17_19, source='oper', test=True)	
    del oper_17_19
    gc.collect() 
    ...
    avohilmo_to_process = [avohilmo_2020,avohilmo_2021]
    for avohilmo in avohilmo_to_process:
        AvoHilmo_processing(avohilmo, DOB_map=DOB_map, extra_to_merge=oper_20_21, source='oper', test=True)
    del oper_20_21
    gc.collect() 	
...
if __name__ == '__main__':
    ...
    p_avohilmo_icd10 = multiprocessing.Process(target=preprocess_avohilmo_icd10)
    p_avohilmo_icpc2 = multiprocessing.Process(target=preprocess_avohilmo_icpc2)
    p_avohilmo_oral = multiprocessing.Process(target=preprocess_avohilmo_oral)
    p_avohilmo_oper = multiprocessing.Process(target=preprocess_avohilmo_oper)
    ...
    p_hilmo.start()
    p_avohilmo_icd10.start()
    p_avohilmo_icpc2.start()
    p_avohilmo_oral.start()
    p_avohilmo_oper.start()
    p_death.start()
    p_cancer.start()
    ...
    p_hilmo.join()
    p_avohilmo_icd10.join()
    p_avohilmo_icpc2.join()
    p_avohilmo_oral.join()
    p_avohilmo_oper.join()
    p_death.join()
    p_cancer.join()
